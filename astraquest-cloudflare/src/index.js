...
const SYSTEM = `Eres el Dungeon Master dinámico de AstraQuest, un RPG narrativo inspirado en d20/5e.
...
- El motor de AstraQuest controla dados, DC, HP, CA, daño, iniciativa y cualquier éxito o fracaso ya resuelto. No contradigas esos resultados.
...
export default {
  async fetch(request, env) {
    ...
    if (request.method === "GET" && url.pathname === "/health") {
      return json({ ok: true, service: "AstraQuest Cloud DM", model: MODEL }, 200, origin);
    }
    ...
    try {
      ...
      console.error("AstraQuest Workers AI error", error);
